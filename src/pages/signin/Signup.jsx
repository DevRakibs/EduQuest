      ...
      <Stack alignItems='center' sx={{ width: { xs: '100%', md: '50%' } }}>
        {
          forgotePassSecOpen ? (
            ...
            <Stack sx={{
              ...
              <Typography sx={{ fontWeight: 600, fontSize: '25px', mb: 3 }}>Sign Up</Typography>
              <TextField
                onChange={handleInputChange}
                name='name'
                value={payload.name}
                // error={payloadError.name !== ''}
                helperText={payloadError && payloadError.name}
                sx={{ mb: 2 }}
                fullWidth
                label="Full Name"
                variant="standard"
              ...
              <Box sx={{ display: 'inline-flex', alignSelf: 'center', mt: 2 }}>
                <Typography sx={{ whiteSpace: 'nowrap', fontSize: { xs: '14px', md: '16px' } }}>Have an Account?</Typography>
                <Link style={{ textDecoration: 'none' }} to='/signin'>
                  <Typography sx={{ whiteSpace: 'nowrap', fontSize: { xs: '14px', md: '16px' }, color: 'primary.main', ml: 1 }}>Login</Typography>
                </Link>
              </Box>
            </Stack>
          )
